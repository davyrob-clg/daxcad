...
C
      ...
      INTEGER*4 PNUM,POPNUM,NLEN,MNUM,TMEN,TCELL,REMV
      INTEGER*2 FMIPOS,ENT,CLTYPE
      REAL DEGANG,RAD,DEG
...
C
     ...
     +     SX1,SY1
      ...
      INTEGER*2 TENT,ENT,P,FMIPOS
      INTEGER*4 C,NUMRES,FLG,I,CELL,JMP, REMV
...
C
     ...
     +     SX1,SY1
      INTEGER*2 ENT,P,FMIPOS
      INTEGER*4 C,JMP , REMV      
      LOGICAL OK,FIRST,CVERFY
      EXTERNAL DISTXY,PI,CVERFY
C
      FMIPOS=NMIPOS
